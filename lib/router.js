...
Router.onAfterAction(setClearMenu, {except: ['plan', 'sms', 'myActionList', 'reports', 'userList', 'referenceDataList', 'dashboard', 'intents', 'profileItem', 'adminSettings', 'organisation', 'feedbackList']});
