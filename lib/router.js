...
Router.onAfterAction(setHome, {only: 'home'});
Router.onAfterAction(setProfile, {only: 'profileItem'});

Router.onAfterAction(setClearMenu, {except: ['plan', 'sms', 'myActionList', 'reports', 'userList', 'referenceDataList', 'home', 'intents', 'profileItem']});
