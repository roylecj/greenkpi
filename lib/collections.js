...
Meteor.methods({
  ...
  removeReferenceItem: function(id) {
    Meteor.call('logAudit', 'method-removeReferenceItem', 'START: id=' + id, 0);

    ReferenceData.remove({_id: id});

    Meteor.call('logAudit', 'method-removeReferenceItem', 'END', 0);
  },
  addUser: function(userCode, userName, emailAddress, userGroup, activeFlag) {

    Meteor.call('logAudit', 'method-addUser', 'START: userCode=' + userCode + ',userName=' + userName + ',emailAddress=' + emailAddress + ',userGroup=' + userGroup + ',activeFlag=' + activeFlag, 0);
    ...
    Accounts.createUser({
     ...
     Meteor.call('logAudit', 'method-addUser', 'END', 0);
  },
