...
//    Roles.addUsersToRoles(userId, userGroup);
    // Roles.addUsersToRoles(result, userGroup);

//    userId = Meteor.users.findOne({username: userCode});
//    Roles.addUsersToRoles(userId, userGroup);
  },
...
//      console.log(Roles.userIsInRole(userId, "STANDARD"));
